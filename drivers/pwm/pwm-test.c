...
struct pwm_test {
	...
	unsigned long period_s, duty_s, run_s, polarity_s, config_s,
		      requested_s;
	struct device *dev;
};
...
static DEVICE_ATTR(request, 0644 , pwm_test_show_request,
		pwm_test_store_request);
